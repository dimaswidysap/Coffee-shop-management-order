   ...
   <section class="w-full md:pl-[13rem] lg:pl-[16rem] pr-[1rem]">
        <section class="w-full flex gap-3 background-secondary rounded-md py-2.5 px-1.5 shadow-md">
            <a href=""
                ...
                <span class="font-bold text-sm font-dark">Tambah Kategori</span>
            </a>
        </section>
    </section>
    ...
    <table class="w-full border-separate border-spacing-y-3">
        ...
        <tbody>
            ...
            <tr class="bg-white shadow-sm rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                <td class="py-4 text-sm text-gray-600 rounded-l-xl">
                    <span class="px-4">{{ $item->id }}</span>
                </td>
                <td class="py-4 text-sm text-gray-600 px-2">
                ...
                <td class="py-4 rounded-r-xl w-1 whitespace-nowrap">
                    <div class="flex items-center justify-start gap-2 pr-4">
                        <button class="p-1.5 border border-gray-200 rounded text-gray-500 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                        </button>
                        <button class="p-1.5 border border-gray-200 rounded text-gray-500 hover:bg-yellow-50 hover:text-yellow-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                        </button>
                        <button class="p-1.5 border border-gray-200 rounded text-gray-500 hover:bg-red-50 hover:text-red-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
